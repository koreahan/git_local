 ...
 * Generated at: 2020-12-10 06:14:21 UTC
...
public final class get_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<style>\r\n");
      out.write("\t\t\t.reply{\r\n");
      out.write("\t\t\t\tborder-bottom: 1px solid #ff8b77;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t</style>\r\n");
      out.write("\t</head>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"button primary small cancel\">취소</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t})\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t$(\".cancel\").on(\"click\", function(e){\r\n");
      out.write("\t\t\t\t\te.preventDefault();\r\n");
      out.write("\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t{reply:replyValue, replyer:replyerValue, bno:bnoValue}, \r\n");
      out.write("\t\t\t\t\t\tfunction(result){ alert(result + \" 등록 완료\"); location.reload();});\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t$(document).ready(function(){\r\n");
      out.write("\t\t\t\t\tvar bnoValue = \"");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${replyPageNum}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\" || 1;\r\n");
      ...
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t//JS 미디어 쿼리\r\n");
      out.write("\t\t\t\t\t\t//페이지 이동 시 a태그의 class이름은 'changePage'로 설정한다.\r\n");
      out.write("\t\t\t\t\t\t//각 a태그의 href에는 이동할 페이지번호만 작성해준다.\r\n");
      out.write("\t\t\t\t\t\tif(matchMedia(\"screen and (max-width:918px)\").matches){\r\n");
      out.write("\t\t\t\t\t\t\t//918px보다 작거나 같을 때 들어온다.\r\n");
      out.write("\t\t\t\t\t\t\t//현재 페이지만 나타내고, 이전과 다음으로 -1, +1씩 이동하도록 구현\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t//이전\r\n");
      out.write("\t\t\t\t\t\t\tif(pageNum > 1){\r\n");
      out.write("\t\t\t\t\t\t\t\tstr += \"<a class='changePage' href='\"+ (pageNum - 1) +\"'><code>&lt;</code></a>\";\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t//현재 페이지\r\n");
      out.write("\t\t\t\t\t\t\tstr += \"<code>\"+ pageNum +\"</code>\";\r\n");
      out.write("\t\t\t\t\t\t\t//다음\r\n");
      out.write("\t\t\t\t\t\t\tif(pageNum != realEnd){\r\n");
      out.write("\t\t\t\t\t\t\t\tstr += \"<a class='changePage' href='\"+ (pageNum + 1) +\"'><code>&gt;</code></a>\";\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\t//919px 이상일 때 들어온다.\r\n");
      out.write("\t\t\t\t\t\t\t//현재 페이지를 제외한 다른 페이지는 a태그로 클릭 가능\r\n");
      out.write("\t\t\t\t\t\t\t//10개씩 페이지를 구성한다(1~10, 11~21,...)\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t//이전\r\n");
      out.write("\t\t\t\t\t\t\tif(prev){\r\n");
      out.write("\t\t\t\t\t\t\t\tstr += \"<a class='changePage' href='\"+ (startNum - 1) +\"'><code>&lt;</code></a>\"\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t//현재 페이지(시작 페이지부터 끝 페이지까지)\r\n");
      ...
      out.write("\t\t\t\t\t\t\te.preventDefault();\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\tvar targetNum = $(this).attr(\"href\");\r\n");
      out.write("\t\t\t\t\t\t\t//pageNum에 사용자가 요청한 페이지로 최신화\r\n");
      out.write("\t\t\t\t\t\t\tpageNum = parseInt(targetNum);\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\tshowList(pageNum);\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t//댓글이 없음\r\n");
      out.write("\t\t\t\t\t\t\t\treplyUL.html(\"댓글이 없습니다\");\r\n");
      out.write("\t\t\t\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t//있으면 그 만큼 반복해서 html()로 뿌리기\r\n");
      out.write("\t\t\t\t\t\t\tfor(var i=0, len = list.length || 0; i < len; i++){\r\n");
      out.write("\t\t\t\t\t\t\t\tstr += \"<li>\";\r\n");
      out.write("\t\t\t\t\t\t\t\tstr += \"<strong>\" + list[i].replyer + \"</strong>\";\r\n");
      out.write("\t\t\t\t\t\t\t\tstr += \"<p class='reply\" + list[i].rno + \"'>\" + list[i].reply +\"</p>\";\r\n");
      out.write("\t\t\t\t\t\t\t\tstr += \"<div style='text-align:right'>\";\r\n");
      out.write("\t\t\t\t\t\t\t\tstr += \"<strong>\" + replyService.displayTime(list[i].replyDate) + \"</strong>\"\r\n");
      out.write("\t\t\t\t\t\t\t\tstr += \"<br><a href='\" + list[i].rno + \"' class='modify'>수정</a>\";\r\n");
      out.write("\t\t\t\t\t\t\t\tstr += \"<a href='\" + list[i].rno + \"' class='finish' style='display:none'>수정 완료</a>\";\r\n");
      out.write("\t\t\t\t\t\t\t\tstr += \"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\"\r\n");
      out.write("\t\t\t\t\t\t\t\tstr += \"<a href='\" + list[i].rno + \"' class='remove'>삭제</a>\";\r\n");
      out.write("\t\t\t\t\t\t\t\tstr += \"</div>\";\r\n");
      out.write("\t\t\t\t\t\t\t\tstr += \"<div class='reply'></div>\"\r\n");
      out.write("\t\t\t\t\t\t\t\tstr += \"</li>\";\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\te.preventDefault();\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\tvar rnoValue = $(this).attr(\"href\");\r\n");
      out.write("\t\t\t\t\t\t\t\tvar replyTag = $(\".reply\" + rnoValue);\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\treplyTag.html(\"<textarea class='\" + rnoValue + \"'>\" + replyTag.text() + \"</textarea>\");\r\n");
      out.write("\t\t\t\t\t\t\t\t$(this).hide();\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\tvar finishs = $(\".finish\");\r\n");
      out.write("\t\t\t\t\t\t\t\tfor(var i=0; i<finishs.length; i++){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tif(finishs[i].getAttribute(\"href\") == rnoValue){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tfinishs[i].style.display = \"inline\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tbreak;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t});\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tvar rnoValue = $(this).attr(\"href\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\treplyService.update({rno : rnoValue, reply : $(\".\" + rnoValue).val()}, function(result){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tif(result == \"success\"){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\talert(\"수정 완료\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t//showList(pageNum);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tlocation.replace(\"/board/get");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${cri.getListLink()}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("&replyPageNum=\" + pageNum + \"&bno=\" + bnoValue);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t$(\".remove\").on(\"click\", function(e){\r\n");
      out.write("\t\t\t\t\t\t\t\te.preventDefault();\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\treplyService.remove($(this).attr(\"href\"), function(result){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tif(result == \"success\"){\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${board.bno}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\";\r\n");
      out.write("//\t\t\t\treplyService.update({rno:42, bno:bnoValue, reply:\"수정된 댓글\"}, function(result){alert(result + \" MODIFIED\")})\r\n");
      out.write("\t\t\t</script>\r\n");
      out.write("\t</body>\r\n");
      out.write("</html>\r\n");
      out.write("\r\n");
